...
//        configProps.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);
        configProps.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, CustomJsonDeserializer.class);
        configProps.put("type", UserEventDto.class);
//        configProps.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, JsonDeserializer.class);
//        JsonDeserializer<UserEventDto> deserializer = new JsonDeserializer<>(UserEventDto.class);
//        deserializer.addTrustedPackages("org.example.taskservice.entity.dto");
